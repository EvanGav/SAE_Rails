...
public class JoueurProfTest {
    ...
    void testJouerTourCapturerTunnelOK() {
        ...
        System.out.println(joueur2.getCartesWagon());
    ...
    void testJouerTourCapturerFerry() {
        ...
        System.out.println(getRouteParNom("Palermo - Roma").possedeCouleur(joueur3));
        joueur3.jouerTour();
        System.out.println(getRouteParNom("Palermo - Roma").valide(joueur3));
